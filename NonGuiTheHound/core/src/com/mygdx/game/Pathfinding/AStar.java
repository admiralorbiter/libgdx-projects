...
public class AStar {
    ...
    public void setBlocks(List<Point> blockedPoints) {
        for(int i=0; i<blockedPoints.size(); i++) {
            int row=blockedPoints.get(i).y;
            int col=blockedPoints.get(i).x;
            setBlock(row, col);
        }
    }

    public java.util.List<Node> findPath() {
    ...
    private java.util.List<Node> getPath(Node currentNode) {
